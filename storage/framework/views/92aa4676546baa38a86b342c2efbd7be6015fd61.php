...
<?php $__env->startSection('content'); ?>
	...
	<div class="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center"
		...
		<div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
			...
			<form class="mt-8 space-y-3" action="<?php echo e(route('ec.update', $barang->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="nama" id="nama" required autofocus value="<?php echo e(old('nama', $barang->nama)); ?>">
...
unset($__errorArgs, $__bag); ?> name="harga" id="harga" required autofocus value="<?php echo e(old('harga', $barang->harga)); ?>"">
...
unset($__errorArgs, $__bag); ?> form-siswa name="diskon" id="diskon" autofocus value="<?php echo e(old('diskon', $barang->diskon)); ?>">
...
<?php echo $__env->make('components.parent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\New folder\Alkademi\Laravel\tugas-asm\resources\views/E-commerce/edit.blade.php ENDPATH**/ ?>